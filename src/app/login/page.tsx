    ...
    <div className="min-h-screen bg-axe-black flex items-center justify-center px-4 pt-16">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-axe-white mb-2">
            {mode === "login" ? "Connexion" : "Créer un compte"}
          </h1>
          <p className="text-axe-muted text-sm">
            {mode === "login" ? "Accédez à votre espace AXE." : "Rejoignez AXE en tant que client ou professionnel."}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-axe-muted mb-1.5">Mot de passe</label>
            <input
              type="password"
              value={password}
        ...
        <p className="text-center mt-6 text-sm text-axe-muted">
